...
async def openai_llm_generator(prompt: str, temperature: float, n: int):
    ...
    data = {"model":"gpt-4o","messages":[{"role":"system","content":system_prompt},{"role":"user","content":prompt}],"temperature":0.8,"max_tokens":2000}
    async with aiohttp.ClientSession() as session:
        async with session.post(url, headers=headers, json=data) as response:
            ...
            return (items, {'input_tokens': pt, 'output_tokens': ct})
